...
public class PanelMother extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabelMother, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 100, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelMother.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelMother().setVisible(true);
            }
        });
    }
