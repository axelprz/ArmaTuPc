...
public class PanelMousePad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelTitulo2.setText("Mouse Pad");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelMousePad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelMousePad().setVisible(true);
            }
        });
    }
